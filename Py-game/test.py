...
while running:
    ...
    if game_over:
        if keys[pygame.K_r]:
            ...
            ball_pos[0] = WIDTH // 2
            ball_pos[1] = HEIGHT // 2
            obstacles = generate_obstacles(5)  # Reset obstacles for level 1
        ...
        for obstacle in obstacles:
            pygame.draw.polygon(screen, YELLOW, [(obstacle[0], obstacle[1] - 15),
                                                 (obstacle[0] - 15, obstacle[1] + 10),
                                                 (obstacle[0] + 15, obstacle[1] + 10)])
        display_score()
